...
import productDerivativeAlternativeJson from "~/data/products/materials/product-oil-coconut-derivative.json";


const productDerivativeAlternative = ref(productDerivativeAlternativeJson);
...
const filterById = () => {
  ...
  filteredProduct.value = productDerivativeAlternative.value.find(product => product.id === route.params.id);
