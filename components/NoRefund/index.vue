  ...
  <div class="ptb-60">
    <div class="container">
      <div class="main-content-text">
        ...
        <h3>Important Information Regarding Bulk Order Refunds</h3>
        <p>
          We understand that circumstances can change, but due to the unique considerations involved in fulfilling
          large, bulk orders (such as specialized sourcing, production, and inventory management), we are unable to
          provide refunds.
        </p>
        <p>
